...
VALUES (0, 'Духи', 100.00, '2023-02-24 00:00:00'),
       (0, 'Духи', 110.00, '2023-02-26 00:00:00'),
       (0, 'Духи', 120.00, '2023-02-27 00:00:00'),
       (1, 'Шампунь', 50.00, '2023-02-24 00:00:00'),
       (1, 'Шампунь', 55.00, '2023-02-25 23:59:59'),
       (1, 'Шампунь', 60.00, '2023-02-26 00:00:00'),
       (2, 'Приправа', 10.00, '2023-02-24 00:00:00'),
       (2, 'Приправа', 15.00, '2023-02-25 23:59:59'),
       (2, 'Приправа', 20.00, '2023-02-28 00:00:00'),
       (0, 'Духи', 120.00, '2023-03-1 23:59:59'),
       (1, 'Шампунь', 60.00, '2023-03-01 00:00:00');
